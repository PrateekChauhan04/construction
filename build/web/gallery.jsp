<%-- 
    Document   : gallery
    Created on : Jul 25, 2019, 9:26:06 PM
    Author     : NEO
--%>
...
<script src="plug/lib/jquery.js" type="text/javascript"></script>

<script src="plug/js/lc_lightbox.lite.js" type="text/javascript"></script>
<link rel="stylesheet" href="plug/css/lc_lightbox.css" />


<!-- SKINS -->
<link rel="stylesheet" href="plug/skins/minimal.css" />


<!-- ASSETS -->
<script src="plug/lib/AlloyFinger/alloy_finger.min.js" type="text/javascript"></script>
...
<body>
	<div class="content">
   		...
   		<a class="elem" href="imge.jpg">
        	<span style="background-image: url(imge.jpg);"></span>
        </a>
            
            <a class="elem" href="imge2.jpg">
        	<span style="background-image: url(imge2.jpg);"></span>
        </a>
            
          <a class="elem" href="imge3.jpg">
        	<span style="background-image: url(imge3.jpg);"></span>
        </a>
