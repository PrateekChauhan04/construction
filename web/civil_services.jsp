       ...
       <li class="nav-item">
        <a class="nav-link" href="contact.jsp">Contact Us</a>
            ...
            <article class="col-lg-12 article2">
                <div>
                    <h2 class="heading1">CIVIL CONSTRUCTION SERVICES</h2>
                    <p class="para1">Home / Services / Civil Construction Services</p>
                </div>
            </article>
            </div>
...
position: relative;
    ...
    font-size: 1.714em;
    color: inherit;
    font-family: inherit;">CIVIL CONSTRUCTION SERVICES</h3>
