       ...
       <li class="nav-item">
        <a class="nav-link" href="contact.jsp">Contact Us</a>
            ...
            <article class="col-lg-12 article2">
                <div>
                    <h2 class="heading1">STRUCTURAL DRAWING & CONSTRUCTION SERVICES</h2>
                    <p class="para1">Home / Services / Structural Drawing
                </div>
            </article>
            </div>
...
position: relative;
    ...
    font-size: 1.714em;
    color: inherit;
    font-family: inherit;">STRUCTURAL DRAWING & CONSTRUCTION SERVICES</h3>
